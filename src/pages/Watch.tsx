  ...
  return (
    <>
      {currentPlaying && currentPlaying?.videoId === id && (
        <div className="max-h-screen -ml-20 overflow-hidden">
          ...
          <div className="flex w-full relative" style={{ height: "92.5vh" }}>
            <div className="lg:flex-row relative flex flex-col gap-y-10 gap-x-5 p-7 mx-20 mr-0 w-full overflow-auto">
              <div>
                <div className="">
                  <iframe
                    // width="700"
                    // height="502"
                    className="w-[100%] h-[302px] sm:h-[500px] overflow-hidden "
                  ...
                  <div className="mt-5">
                    ...
                    <div className="flex flex-col lg:justify-between mt-1">
                    ...
                    <div className="flex gap-4 flex-col border-solid border-gray-400 border-2 my-5 pb-3 border-l-transparent border-r-transparent">
                      <div className="lg:grid grid grid-cols-1 items-center gap-5 mr-5 mt-4">
                        <div>
                          <img
              ...
              <div className="mr-0 flex flex-col gap-3">
